...
export default function Courses() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8888/grading-management-system/api/courses').then(res => {
            setCourses(res.data)
        })
    }, [])
    ...
    const handleAddCourse = () => {
        axios.post('http://localhost:8888/grading-management-system/api/courses', courseData).then(res => {
