...
export default function Members() {
    ...
    const handleAddMember = () => {
        if(newMemberData.role === 'student') {
            axios.post('https://king-prawn-app-66oof.ondigitalocean.app/api/students', {
            ...
            axios.post('https://king-prawn-app-66oof.ondigitalocean.app/api/professors', {
                firstName: newMemberData.firstName,
                lastName: newMemberData.lastName,
                email: newMemberData.email,
                password: newMemberData.password
    ...
    const handleDeleteMember = (id, role) => {
        if(role === 'student') {
            axios.delete(`https://king-prawn-app-66oof.ondigitalocean.app/api/students/${id}`).then(res => {
                setStudents(students.filter(student => student.id !== id))
                window.alert(`Successsfuly deleted ${student.firstName}`)
            })
        } else {
            axios.delete(`https://king-prawn-app-66oof.ondigitalocean.app/api/professors/${id}`).then(res => {
    ...
    const handleEditMember = () => {
        if(newMemberData.role === 'student') {
            axios.put(`https://king-prawn-app-66oof.ondigitalocean.app/api/students/${newMemberData.id}`, {
                firstName: newMemberData.firstName,
                lastName: newMemberData.lastName,
                email: newMemberData.email,
                password: newMemberData.password
            ...
            axios.put(`https://king-prawn-app-66oof.ondigitalocean.app/api/professors/${newMemberData.id}`, {
                firstName: newMemberData.firstName,
                lastName: newMemberData.lastName,
                email: newMemberData.email,
                password: newMemberData.password
